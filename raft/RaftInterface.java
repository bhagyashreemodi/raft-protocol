...
public interface RaftInterface {
    VoteResult RequestVote(int term, int candidateId, int lastLogIndex, int lastLogTerm) throws RemoteObjectException;
    AppendEntriesResult AppendEntries(int term, int leaderId, int prevLogIndex, int prevLogTerm, List<LogEntry> entries, int leaderCommit) throws RemoteObjectException;

    int GetCommittedCmd(int index) throws RemoteObjectException;
    StatusReport GetStatus() throws RemoteObjectException;
    StatusReport NewCommand(int command) throws RemoteObjectException;

//    boolean getActiveStatus() throws RemoteObjectException;
}
