...
/** Runs all tests for lab 2 Raft implementation.
    ...
    <li>{@link test.raft.TestCheckpoint_BasicAgree}</li>
...
public class Lab2Tests {
    ...
    public static void main(String[] arguments) {
        ...
        Class<? extends Test>[] tests = new Class[] {
            ...
            test.raft.TestCheckpoint_BasicAgree.class,
        ...
        points.put("test.raft.TestCheckpoint_BasicAgree", 40);
